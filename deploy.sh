# build images
docker build -t kumar003vinod/multi-client:latest -t kumar003vinod:multi-client:$GIT_SHA ./client/
docker build -t kumar003vinod/multi-server:latest -t kumar003vinod:multi-server:$GIT_SHA ./server/
docker build -t kumar003vinod/multi-worker:latest -t kumar003vinod:multi-worker:$GIT_SHA ./worker/
# push images
